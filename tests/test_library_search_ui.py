...
class LibrarySearchUITests(unittest.TestCase):
    def test_library_has_themed_search_block_and_clear_action(self) -> None:
        ...
        self.assertIn("bgcolor=ft.Colors.SURFACE_CONTAINER", library_search_source)
        ...
        self.assertIn('f"Найдено: {result_count}"', library_search_source)
    ...
    def test_live_search_is_debounced(self) -> None:
        ...
        self.assertIn(
            "_LIBRARY_SEARCH_DEBOUNCE_SECONDS = 0.22", library_search_source
        )
        ...
        self.assertIn("revision != app._search_revision", library_search_source)
